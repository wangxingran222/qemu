...
void qemu_plugin_tb_restore_cb(CPUState *cpu, struct qemu_plugin_tb_restore *tb);
void qemu_plugin_tb_recompile_io_cb(CPUState *cpu, struct qemu_plugin_tb_recompile_io *tb);

 ...
 */
QEMU_DISABLE_CFI
void qemu_plugin_tb_restore_cb(CPUState *cpu, struct qemu_plugin_tb_restore *tb_restore)
{
    struct qemu_plugin_cb *cb, *next;
 ...
 */
QEMU_DISABLE_CFI
void qemu_plugin_tb_recompile_io_cb(CPUState *cpu, struct qemu_plugin_tb_recompile_io *tb_recompile_io)
{
    struct qemu_plugin_cb *cb, *next;

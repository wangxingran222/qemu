...
static void vcpu_tb_restore(qemu_plugin_id_t id, struct qemu_plugin_tb_restore *tb_restore)
{
    unsigned int cpu_index = qemu_plugin_tb_restore_cpu_index(tb_restore);
    CPUCount *count = qemu_plugin_scoreboard_find(counts, cpu_index);
...
{
    unsigned int cpu_index = qemu_plugin_tb_recompile_io_cpu_index(tb_recompile_io);
    CPUCount *count = qemu_plugin_scoreboard_find(counts, cpu_index);
